...
@onready var normal_map = $"."

#==================================
# ==== Desativar e ativar mapa ====
#==================================
func _desativar_realidade():
	normal_map.get_node("tileMap").hide() #visual - tilemap 
	normal_map.get_node("tileMap/solo").enabled = false

func _reativar_realidade():
	normal_map.get_node("tileMap").show() #visual - tilemap
	normal_map.get_node("tileMap/solo").enabled = true
